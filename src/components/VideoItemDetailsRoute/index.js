...
class VideoDetails extends Component {
    ...
    renderSpecificVideoDetails = () => (
        ...
        {value =>{
            ...
            return(
                ...
                {likeIcon} <ViewsText color={likeClass}>Like </ViewsText>
                </IconContainer>
                <IconContainer color={dislikeClass} type="button" onClick={onClickDislikeButton}>
                {dislikeIcon} <ViewsText color={dislikeClass}>Dislike</ViewsText>
                </IconContainer>
                <IconContainer onClick={saveVideoToList}
    ...
    renderFailureView = () => (
        ...
        <NavLink>
        <Retry className="button" type="button" onClick={this.getSuggestionVideos}>
        Retry 
        </Retry>
        </NavLink>
        </NotFoundContainer>
